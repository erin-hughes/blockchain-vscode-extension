...
export async function associateTransactionDataDirectory(chaincode?: InstantiatedTreeItem | ContractTreeItem, associateFromViewOptions?: any ): Promise<any> {
    ...
    if (associateFromViewOptions) {
        ...
        // TODO - by default this dialog should open the transaction_data folder of the smart contract project if present
